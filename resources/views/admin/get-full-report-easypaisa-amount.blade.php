    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Easypaisa Amount List</h6>
            </div>
            <div class="card-body">
                <div>
    ...
    <div class="row p-2">
        ...
        <div>
            ...
            <input type="button"  value="View" class="btn btn-primary" id="get_easypaisa_view">
        </div>
</div>
{{-- </form> --}}
...
$.ajax({
    headers: {
        ...
        url:"{{ url('easypaisa-full-report-second-view-pdf') }}",
        type:"get",
        data:{from_date:from_date,to_date:to_date,type:type,employee_others:employee_others, search_value : search_value },
        success:function(data){
...
// $(document).on("click", "#get_easypaisa_view", function() {
...
// if(from_date!=="" && to_date!=="")
// {   
//     var url = "{{ url('view-report-easypaisa-amount') }}" + "/" + from_date + "/" + to_date + "/" + type + "/" + employee_others;
//     viewModal(url);
// }
...
var url = "{{ url('get-view-easypaisa-amount-new-created-second') }}" + "/" + from_date + "/" + to_date + "/" + type + "/" + employee_others;
