        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Easypaisa Account</h6>
                    <div>
...
$('#paid_amount_form').validate({
    ...
    var url = "{{ url('get-full-report-of-easypaisa-amount') }}";
    viewModal(url);
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            var employee_type = $("#employee_type").val(data[1]["employee_type"]);
            var employee_branch = $("#easypaisa_detail_locations").val(data[1]["employee_branch"]);
            getEmployees(data[0]["employee_id"]);
