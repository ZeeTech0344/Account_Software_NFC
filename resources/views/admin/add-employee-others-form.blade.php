            ...
            <div class="card-body">
                <form id="employee-form">
                    ...
                    <div class="form-group">
                        ...
                        <select name="employee_type" id="employee_ty" class="form-control" onkeyup="validate(this)"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cnic" class="form-control" name="cnic"
                            onkeyup="validate(this)">
                    </div>

                    <div class="form-group">
                        <label for="exampleFormControlInput1">Basic Sallary</label>
                        <input type="text" class="form-control" id="basic_sallary" class="form-control"
                            name="basic_sallary" onkeyup="validate(this)">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="employee_status" id="employee_branch" onkeyup="validate(this)"
                            class="form-control">
                            <option>On</option>
                            <option>Off</option>
                        </select>
    ...
    $(document).on("click", ".edit_employee_others", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#employee_ty").val(data["employee_type"]);
